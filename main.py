...
while menu:  ## While not exiting, loop menu
    ...
    elif menu =="3":  ## If our input is 3, search for a song ID
    ...
    elif menu =="4":  ## If our input is 4, search for songs by artist
    ...
    elif menu =="5":  ## If our input is 5, exit the program
      print("\nGoodbye!")
      menu = None  ## Quit menu
